...
customer1 = Customer('Nischal', 'Shakya', 22, 'Male')
customer2 = Customer('Sam', 'Shrestha', 24, 'Female')
...
customer1 = Bank('Nischal', 'Shakya', 2, 'Male')
customer2 = Bank('Sam', 'Shrestha', 15, 'Female')
